...
class HelpController : UIViewController{
    override func viewDidLoad() {
        ...
        <p> Welcome to The Weather App. here you will be able to look throught he map of the world and click a location to find out the current weather in the location. you may also click the button to keep the location in your "Saved places" list. you can access the "Saved places" list by click the bottom list icon in the main screen. </p></br>
        <h2> Gestures </h2>
